import { X, Brain, CheckCircle, Lightbulb, AlertTriangle } from 'lucide-react';
import ReactMarkdown from 'react-markdown';
import remarkMath from 'remark-math';
import rehypeKatex from 'rehype-katex';
import 'katex/dist/katex.min.css';
// Ensure this path matches where you put your utility file
  ...
  const RenderText = ({ content, wrapExpression = false, className = '' }) => (
    <div className={className}>
      <ReactMarkdown
        ...
        components={{
          // 1. GRAND HEADINGS (The "Breaks" you wanted)
          h1: ({node, ...props}) => (
